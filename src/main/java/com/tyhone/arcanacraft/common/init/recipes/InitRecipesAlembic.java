...
public class InitRecipesAlembic {
	public static void init(){
		...
		ArcanacraftCraftingManager.registerAlembicRecipe(new TinktureStack(ModTinktureTypes.REBUS), new TinktureStack(ModTinktureTypes.ALCHEMIC_BASE), new ItemStack(ModItems.ITEM, 1, ItemMetaUtil.item("emeradine")), new OreStack("treeSapling", 1));
		...
		ArcanacraftCraftingManager.registerAlembicRecipe(new ItemStack(Items.ENDER_PEARL, 1), new TinktureStack(ModTinktureTypes.QUARTZ_SOLUTION), new ItemStack(ModItems.AYRE, 1), new ItemStack(ModItems.DUST, 1, ItemMetaUtil.dust("ender")));
