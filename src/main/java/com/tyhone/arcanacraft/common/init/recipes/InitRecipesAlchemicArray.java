...
public class InitRecipesAlchemicArray {
	public static void init(){
		...
		ArcanacraftCraftingManager.registerAlchemicArrayRecipe(new ItemStack(ModItems.ITEM, 2, ItemMetaUtil.item("catalyst")), new ItemStack(ModItems.AYRE, 1), new ItemStack(Items.GLOWSTONE_DUST, 2), new ItemStack(Items.REDSTONE, 2), new ItemStack(Items.GUNPOWDER, 1), new ItemStack(Items.CLAY_BALL, 1));
		ArcanacraftCraftingManager.registerAlchemicArrayRecipe(new ItemStack(ModItems.ITEM, 4, ItemMetaUtil.item("catalyst")), new ItemStack(ModItems.AYRE, 1), new ItemStack(Items.GLOWSTONE_DUST, 2), new ItemStack(Items.REDSTONE, 2), new ItemStack(Items.GUNPOWDER, 1), new ItemStack(Items.SLIME_BALL, 1));
		...
		ArcanacraftCraftingManager.registerAlchemicArrayRecipe(new ItemStack(ModItems.DUST, 2, ItemMetaUtil.dust("emeradine")), new ItemStack(ModItems.DUST, 1, ItemMetaUtil.dust("emerald")), new ItemStack(ModItems.AYRE, 1), new ItemStack(ModItems.DUST, 2, ItemMetaUtil.dust("diamond")));
		ArcanacraftCraftingManager.registerAlchemicArrayRecipe(new ItemStack(Items.QUARTZ, 4), new OreStack("blockQuartz"));
		
		ArcanacraftCraftingManager.registerAlchemicArrayRecipe(new ItemStack(ModItems.COMPONENTS, 1, ItemMetaUtil.component("iustare")), new ItemStack (ModItems.ITEM, 1, ItemMetaUtil.item("inert_star")), new ItemStack(ModItems.ESSENCE, 2, ItemMetaUtil.essence("gold")), new ItemStack(ModItems.CRYSTAL, 1, ItemMetaUtil.crystal("arcane")));
		ArcanacraftCraftingManager.registerAlchemicArrayRecipe(new ItemStack(ModItems.COMPONENTS, 1, ItemMetaUtil.component("iniquis")), new ItemStack (ModItems.ITEM, 1, ItemMetaUtil.item("ender_tear")), new ItemStack(ModItems.ESSENCE, 2, ItemMetaUtil.essence("iron")), new ItemStack(ModItems.CRYSTAL, 1, ItemMetaUtil.crystal("arcane")));
