...
public class ContainerVacuumChestEnder extends Container{

	private final IInventory CHEST_INV;
	private final int NUM_ROWS;
	private final TileEntityVacuumChestEnder te;
	
	public ContainerVacuumChestEnder(InventoryPlayer playerInv, TileEntityVacuumChestEnder chestInv, EntityPlayer player) {
		this.te = chestInv;
	...
	public TileEntityVacuumChestEnder getChestInventory() {
		return te;
	}
