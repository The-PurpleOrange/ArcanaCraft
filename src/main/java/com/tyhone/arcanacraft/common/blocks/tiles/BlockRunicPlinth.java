...
public class BlockRunicPlinth extends ModBlockTileEntityBase{

    protected static final AxisAlignedBB PLINTH_AABB = new AxisAlignedBB(0.0625F, 0.0F, 0.0625F, 0.9375F, 1.0F, 0.9375F);
    
	public BlockRunicPlinth() {
		super("runic_plinth");
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityRunicPlinth();
	}
