...
public class BlockVacuumChestEnder extends ModBlockTileEntityBase{

	public BlockVacuumChestEnder() {
		super("vacuum_chest_ender");
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityVacuumChestEnder();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if(ilc != null) {
			player.openGui(Arcanacraft.MODID, Reference.GuiID.GUI_VACUUM_CHEST_ENDER, world, pos.getX(), pos.getY(), pos.getZ());
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntityVacuumChestEnder te = (TileEntityVacuumChestEnder) world.getTileEntity(pos);
