...
import com.tyhone.arcanacraft.common.blocks.blocks.BlockBloodStone.EnumAlchemicStoneType;
...
public class BlockBloodStone extends ModBlockEnum {
	...
	public BlockBloodStone() {
		super("blood_stone", EnumAlchemicStoneType.VARIANTS);
