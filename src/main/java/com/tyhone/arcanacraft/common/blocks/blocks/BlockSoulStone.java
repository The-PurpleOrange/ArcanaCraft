...
import com.tyhone.arcanacraft.common.blocks.blocks.BlockSoulStone.EnumAlchemicStoneType;
...
public class BlockSoulStone extends ModBlockEnum {
	...
	public BlockSoulStone() {
		super("soul_stone", EnumAlchemicStoneType.VARIANTS);
