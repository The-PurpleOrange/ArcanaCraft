...
public class BlockHeavyChest extends ModBlockTileEntityBase{

	public BlockHeavyChest() {
		super("heavy_chest");
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityHeavyChest();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if(ilc != null) {
			player.openGui(Arcanacraft.MODID, Reference.GuiID.GUI_HEAVY_CHEST, world, pos.getX(), pos.getY(), pos.getZ());
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntityHeavyChest te = (TileEntityHeavyChest) world.getTileEntity(pos);
	...
	private ILockableContainer getLockableContainer(World world, BlockPos pos) {
		return this.getContainer(world, pos);
	}


	private ILockableContainer getContainer(World world, BlockPos pos) {
