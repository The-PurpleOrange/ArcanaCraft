...
public class RenderTileEntityTransmutationAltar extends TileEntitySpecialRenderer{
	
	public RenderTileEntityTransmutationAltar(RenderManager renderManager, RenderItem renderItem){	
	}
	
	@Override
	public void render(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
		TileEntityTransmutationAltar pedestal = (TileEntityTransmutationAltar) te;
		...
		if(itemStack != null && itemStack.getCount()>0){ //Check if there is an item in slot 0
            ...
            try{
                ...
                Arcanacraft.logger.log(Level.ERROR, "Something went wrong trying to render an item in a Transmutation Altar! The item is "+itemStack.getItem().getRegistryName()+"! - " +  e);
            }
