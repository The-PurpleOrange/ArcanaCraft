...
public class RenderTileEntityAlchemicArray extends TileEntitySpecialRenderer{
	
	private static final ResourceLocation CIRCLE_INNER = new ResourceLocation(Arcanacraft.MODID + ":textures/models/alchemic_array/alchemic_array_inner.png");
	private static final ResourceLocation CIRCLE_OUTER = new ResourceLocation(Arcanacraft.MODID + ":textures/models/alchemic_array/alchemic_array_body.png");
	
	
	public RenderTileEntityAlchemicArray(RenderManager renderManager, RenderItem renderItem){	
	}
