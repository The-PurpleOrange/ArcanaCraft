...
public class RenderTileEntitySoulAltar extends TileEntitySpecialRenderer{
	
	public RenderTileEntitySoulAltar(RenderManager renderManager, RenderItem renderItem){	
	}
	
	@Override
	public void render(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
		TileEntitySoulAltar pedestal = (TileEntitySoulAltar) te;
